...
)
{
	...
	)) == STATUS_INFO_LENGTH_MISMATCH)
	{
		...
		Buffer = (PSYSTEM_PROCESS_INFO)ExAllocatePoolWithTag(PagedPool, BufferSize, KEINJ_POOL_TAG);
	}
...
{
	PKAPC AlertThreadApc = (PKAPC)ExAllocatePoolWithTag(NonPagedPool, sizeof(KAPC), KEINJ_POOL_TAG);
	PKAPC ExecutionApc   = (PKAPC)ExAllocatePoolWithTag(NonPagedPool, sizeof(KAPC), KEINJ_POOL_TAG);
