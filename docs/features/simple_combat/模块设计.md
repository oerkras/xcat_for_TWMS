...
> **瞬移锚点**：[`../teleport/模块设计.md`](../teleport/模块设计.md) · **唯一** `TeleportNativeSkillCall`（fill+Doing · `fill_slim`）  
...
- settle / 互斥在 SM 内；**禁止** Settling 再调 SyncRel / ImpactNext / HealVisual 抢收态（收态靠 fill_slim 内仅 `Apl←Ap`；见 teleport P0d）。
