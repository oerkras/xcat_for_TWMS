...
void DrawGamaPassSlotRow(LaunchUiState& ui, bool slotsLocked, float rowW, float gap) {
    ...
    if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
        ImGui::SetTooltip(
            "游戏昵称列表序号：1=第一个（不含「建立暱稱」）。"
            "新号请在弹出窗自己点「建立遊戲暱稱」填名字，建好后会自动继续。"
            "读秒中可改，换票开始后不可改。");
    }
}
...
void DrawLaunchCompactBar(LaunchUiState& ui) {
    ...
    // —— 行 1：启动模式 ——
        ...
        if (ImGui::Combo("##launch_mode", &modeIdx, items, 4)) {
            ...
            if (modeIdx == 2) {
                ImGui::SetTooltip(
                    "账密直登会另开一扇 XCAT 专用浏览器（独立登录罐），\n"
                    "不是你日常用的 Chrome / Edge。");
            } else if (modeIdx == 1) {
                ImGui::SetTooltip("用你日常浏览器点选 Gama Pass 换票。不另开独立罐。");
            }
            }
        }
    ...
    // —— 行 2：模式相关（账号/昵称 · 验证码 · 监视/注入）——
        ...
        ImGui::PushTextWrapPos(ImGui::GetCursorPos().x + rowW);
...
// 调试 TAB「解绑」：开着则攻击无CD 不再强制遇人三项。默认关（仍绑定）。
static bool gUiAttackNoCdEncounterUnbind = false;
...
static bool gUiMobGatherSlowNearOnly = xcat::kMobGatherSlowNearOnlyDefault != 0;
static int gUiMobGatherSlowNearPx = (int)xcat::kMobGatherSlowNearPxDefault;
static bool gUiMobGatherWzLeashOn = xcat::kMobGatherWzLeashOnDefault != 0;
static int gUiMobGatherWzLeashSlowPx = (int)xcat::kMobGatherWzLeashSlowPxDefault;
static bool gUiMobGatherSkipSlowTpl = xcat::kMobGatherSkipSlowTplDefault != 0;
static int gUiMobGatherSkipSlowSpeed = (int)xcat::kMobGatherSkipSlowSpeedDefault;
...
static bool gUiMobGatherReconnectHop = xcat::kMobGatherReconnectHopDefault != 0;
static bool gUiMobGatherReconnectHopPin = xcat::kMobGatherReconnectHopPinDefault != 0;
static int gUiMobGatherReconnectHopChannel = (int)xcat::kMobGatherReconnectHopChannelDefault;
...
static bool gUiMobGatherFirstGenOnly = xcat::kMobGatherFirstGenOnlyDefault != 0;
...
// 「攻击无CD」写盘强制关。「出刀软重连」不改盘上勾选，DLL 未解锁不计刀、不拆。
...
void DrawHomeTab(LaunchUiState& ui) {
    ...
    if (!ui.prefsBinDir.empty()) {
        ...
        if (xcat::ReadPayloadControl(ui.prefsBinDir.c_str(), disk)) {
            if (!coreLoaded || disk.writeTickMs != lastSeenTick) {
                ...
                gUiAttackNoCdEncounterUnbind = disk.attackNoCdEncounterUnbind != 0;
                ...
                gUiMobGatherSlowNearOnly = disk.mobGatherSlowNearOnly != 0;
                gUiMobGatherSlowNearPx = (int)xcat::ClampMobGatherSlowNearPx(disk.mobGatherSlowNearPx);
                gUiMobGatherWzLeashOn = disk.mobGatherWzLeashOn != 0;
                gUiMobGatherWzLeashSlowPx =
                    (int)xcat::ClampMobGatherWzLeashSlowPx(disk.mobGatherWzLeashSlowPx);
                gUiMobGatherSkipSlowTpl = disk.mobGatherSkipSlowTpl != 0;
                gUiMobGatherSkipSlowSpeed =
                    (int)xcat::ClampMobGatherSkipSlowSpeed(disk.mobGatherSkipSlowSpeed);
                ...
                gUiMobGatherReconnectHop = disk.mobGatherReconnectHop != 0;
                gUiMobGatherReconnectHopPin = disk.mobGatherReconnectHopPin != 0;
                gUiMobGatherReconnectHopChannel = (int)xcat::ClampMobGatherReconnectHopChannel(
                    disk.mobGatherReconnectHopChannel ? disk.mobGatherReconnectHopChannel
                                                      : xcat::kMobGatherReconnectHopChannelDefault);
                ...
                gUiMobGatherFirstGenOnly = disk.mobGatherFirstGenOnly != 0;
    ...
    auto persistCore = [&]() {
        ...
        c.attackNoCdEncounterUnbind = gUiAttackNoCdEncounterUnbind ? 1u : 0u;
        ...
        c.mobGatherSlowNearOnly = gUiMobGatherSlowNearOnly ? 1u : 0u;
        c.mobGatherSlowNearPx = xcat::ClampMobGatherSlowNearPx(
            static_cast<uint32_t>(gUiMobGatherSlowNearPx < 0 ? 0 : gUiMobGatherSlowNearPx));
        c.mobGatherWzLeashOn = gUiMobGatherWzLeashOn ? 1u : 0u;
        c.mobGatherWzLeashSlowPx = xcat::ClampMobGatherWzLeashSlowPx(
            static_cast<uint32_t>(gUiMobGatherWzLeashSlowPx < 0 ? 0 : gUiMobGatherWzLeashSlowPx));
        c.mobGatherSkipSlowTpl = gUiMobGatherSkipSlowTpl ? 1u : 0u;
        c.mobGatherSkipSlowSpeed = xcat::ClampMobGatherSkipSlowSpeed(gUiMobGatherSkipSlowSpeed);
        ...
        c.mobGatherReconnectHop = gUiMobGatherReconnectHop ? 1u : 0u;
        c.mobGatherReconnectHopPin = gUiMobGatherReconnectHopPin ? 1u : 0u;
        c.mobGatherReconnectHopChannel = xcat::ClampMobGatherReconnectHopChannel(
            static_cast<uint32_t>(gUiMobGatherReconnectHopChannel < 1
                                      ? 1
                                      : gUiMobGatherReconnectHopChannel));
        c.mobGatherApplyCtrl = gUiMobGatherApplyCtrl ? 1u : 0u;
        c.mobGatherFirstGenOnly = gUiMobGatherFirstGenOnly ? 1u : 0u;
        ...
        xcat::ApplyAttackNoCdEncounterForce(c);
        c.writeTickMs = GetTickCount64();
...

    {
        ...
        const bool walkGlideInvulnOff =
            gUiFlySpeedPct <= (int)xcat::kHeliWalkGlideSpeedPct;
        if (walkGlideInvulnOff) ImGui::BeginDisabled();
        if (xcat::ui::OptionCheckbox("无敌", &invincible)) persistCore();
        if (walkGlideInvulnOff) {
            ImGui::EndDisabled();
            if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
                ImGui::SetTooltip(
                    "F5 滑翔 ≤1.00X（巡航 620 px/s）时强制关无敌。\n"
                    "勾选会保留，倍率高于 1.00X 后自动恢复。\n"
                    "空中贴怪 / 赶路 / F6 旋翼仍发 Impact（含地上起飞）。");
            }
            ImGui::SameLine();
            ImGui::TextDisabled("1.00X 关");
        }
        ImGui::SameLine();
        ...
        ImGui::SetNextItemWidth(AppDpi_Px(132.f));
        {
            ...
            if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) {
                ImGui::SetTooltip(
                    "单选追怪方式。\n"
                    "· 空中贴怪：悬停在怪旁出刀，可穿层；默认。1.00X 以上需无敌，"
                    "打到 1.00X 强制关无敌。\n"
                    "· 拟人模式：同层走路贴近后 A 键出刀，不做跨层。\n"
                    "· 站桩输出：人原地砍。面前攻击盒（下方横向/竖直，默认 100×80）\n"
        ...
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) {
            ImGui::SetTooltip(
                    "人↔怪 AbsPos 横向半宽（px）。默认 100。0=该轴不限。\n"
        ...
        ImGui::SameLine(0.f, ui::Gap() * 0.45f);
            ...
            if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) {
                ImGui::SetTooltip(
                    "人↔怪 AbsPos 竖直半高（px）。默认 80。0=该轴不限。\n"
        ...
        ImGui::SetItemTooltip(
            ...
            "出刀软重连须解锁吸怪 TAB 才生效（未解锁不开）。\n"
            "秒数闸在同卡「主动软重连」（瞬移找怪+F5 仍会强制开）。");
    }
    CardGap();
    {
        ...
        speedRow("F5 滑翔", "home_combat_speed", &gUiFlySpeedPct,
                 ...
                 "打到 1.00X（巡航 620）强制关无敌；勾选保留，高于 1.00X 后恢复。",
    ...
    CardGap();
    {
        ...
        ImGui::Spacing();
        {
            ...
            if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) {
                ImGui::SetTooltip(
                    "开：500px 内先打周围更密的堆（密度看同一 zMass、250px 活怪数）。\n"
                    "脚边独怪不会压过半径内的堆；超过 500px 仍打欧式最近的，不去追全图。\n"
                    "空中贴怪换怪按欧式距离最近活怪（落点失败也会锁，不跳去远处可落点独怪）。\n"
                    "拟人仍只在同层比。\n"
                    "关：换怪只打欧式距离最近的可打怪\n"
                    "注意：已锁定交手中不会中途改锁——只影响下一次选怪\n"
                    "生效核对：combat.log 出现 SetClusterPriority 1，acquire 的 clusterOn=1");
            }
        }
...
void DrawHangupScheduleTab(LaunchUiState& ui) {
    ...
    xcat::ui::CardGuard card("##tab_hangup", "挂机时段");
        ImGui::TextWrapped("未定位数据目录，无法读写 user.ini [core] 挂机时段。");
        return;
    }
...
void DrawMultiSkillTab(LaunchUiState& ui) {
    ...
    if (ui.prefsBinDir.empty()) {
        ...
        ImGui::TextWrapped("未定位数据目录，无法读写 multiSkill / multiskill_select.tsv。");
        return;
    }
...
void DrawReloginTab(LaunchUiState& ui) {
    ...
    const bool noCdForce = gUiAttackAccelClearBusy && !gUiAttackNoCdEncounterUnbind;
    if (gatherForce) {
        detect = true;
        stopGather = true;
        channelHop = true;
    ...
    if (noCdForce) {
        ImGui::TextDisabled("攻击无CD 开启时强制：检测同图 + 先停手 + 一直有人就换频，关无CD 后才能改。");
    } else if (gUiAttackAccelClearBusy && gUiAttackNoCdEncounterUnbind) {
        ImGui::TextDisabled("已在调试 TAB 解绑攻击无CD 遇人强制，这三项可改。");
    }
...
void DrawTimedKeysTab(LaunchUiState& ui) {
    ...
    if (ui.prefsBinDir.empty()) {
        ...
        ImGui::TextWrapped("未定位数据目录，无法读写 user.ini [timed_keys]。");
        return;
    }
...
void DrawBuffsTab(LaunchUiState& ui) {
    ...
    if (ui.prefsBinDir.empty()) {
        ...
        ImGui::TextWrapped("未定位数据目录，无法读写 user.ini [buffs]。");
        return;
    }
...
void DrawDebugTab(LaunchUiState& ui) {
    {
        ...
        ImGui::TextUnformatted("产品：rtapp");
    ...
    CardGap();
    {
        ...
        ImGui::TextWrapped(
            ...
            "与正式载荷 DLL 注入共用忙锁；成功不标记「已注入载荷」，监视仍会补正式 DLL。");
    ...
    CardGap();
    {
        ...
        ImGui::TextWrapped("载荷 JSONL：数据目录/logs/x.jsonl");
        ImGui::TextWrapped("换票文本：bin/launcher.log");
        ImGui::TextWrapped("账号：仅 bin/account.txt（与启动器同级；不写 LocalAppData）");
    ...
    CardGap();
    {
        ...
        if (!ui.prefsBinDir.empty()) {
            xcat::PayloadControl disk{};
            if (xcat::ReadPayloadControl(ui.prefsBinDir.c_str(), disk)) {
                if (!nocdUnbindDbgLoaded || disk.writeTickMs != nocdUnbindDbgSeen) {
                    gUiAttackNoCdEncounterUnbind = disk.attackNoCdEncounterUnbind != 0;
                    nocdUnbindDbgSeen = disk.writeTickMs;
                    nocdUnbindDbgLoaded = true;
                }
            } else if (!nocdUnbindDbgLoaded) {
                nocdUnbindDbgLoaded = true;
            }
        } else if (!nocdUnbindDbgLoaded) {
            nocdUnbindDbgLoaded = true;
        ...
        if (ImGui::Button("解绑##dbg_nocd_enc", ImVec2(-1.f, 0.f))) {
            ...
            if (ui.prefsBinDir.empty()) {
                ...
                xcat::PayloadControl c{};
                (void)xcat::ReadPayloadControl(ui.prefsBinDir.c_str(), c);
                c.attackNoCdEncounterUnbind = wantUnbind ? 1u : 0u;
                xcat::ApplyAttackNoCdEncounterForce(c);
                c.writeTickMs = GetTickCount64();
                if (xcat::WritePayloadControl(ui.prefsBinDir.c_str(), c)) {
                    gUiAttackNoCdEncounterUnbind = wantUnbind;
                    nocdUnbindDbgSeen = c.writeTickMs;
                    xcat::log::Ok("App", "已下发 core：attackNoCdEncounterUnbind=%d（调试）",
                                  wantUnbind ? 1 : 0);
                    sound::UiClick();
                } else {
                    xcat::log::Warn("App", "写入 user.ini [core] 攻击无CD遇人解绑失败");
                    sound::UiError();
                }
            }
        }
    ...
    CardGap();
    {
        ...
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) {
            ImGui::SetTooltip(
                "主线程泵每个宿主 tick 最多执行多少个排队 job（%u–%u，默认 %u）。\n"
                "队列共 %u 格；默认 Drain 不会一次抽干整队，避免单帧倒进过多托管活。\n"
                "调小=单帧更轻、易 defer/跳刀；调大=吞吐更高、单帧可能更尖。\n"
                "与上方「拥堵让路阈值」无关：那是背压，这项是每 tick 清队上限。",
                (unsigned)xcat::kPumpDrainBudgetMin, (unsigned)xcat::kPumpDrainBudgetMax,
                (unsigned)xcat::kPumpDrainBudgetDefault, (unsigned)xcat::kPumpQueueCap);
        }
        ImGui::SameLine(0.f, ui::Gap() * 0.35f);
        ImGui::TextUnformatted("格");
    }
    CardGap();
    {
        ...
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) {
            ImGui::SetTooltip(
                "贴怪单次 fill 最大距离（下限 %u px，默认 %u，无上限）。\n"
                "空中贴怪 / 瞬移找怪都会用：更远会分段贴近。\n"
                "这是单段距离，不是「不去打远处的怪」——选怪仍先清当前 zMass。\n"
                "过大易软断（lean_local_or_soft）。",
    ...
    CardGap();
    {
        ...
        ImGui::TextWrapped("顶栏可切换主题；偏好写入 %s\\state\\user.ini",
                           ui.prefsBinDir.empty() ? xcat::install::kPayloadDir : ui.prefsBinDir.c_str());
    }
    CardGap();
    {
...
void DrawAutoSkillCard(LaunchUiState& ui) {
    ...
    auto persist = [&]() {
        ...
        ImGui::TextWrapped("未定位数据目录，无法读写 user.ini [auto_skill]。");
                return;
            }
...
void DrawAutoStatTab(LaunchUiState& ui) {
    ...
    if (ui.prefsBinDir.empty()) {
        ...
        ImGui::TextWrapped("未定位数据目录，无法读写 user.ini [auto_stat]。");
        return;
    }
...

    {
        ...
        xcat::AutoStatConfig probe{};
        probe.str = str < 0 ? 0u : static_cast<uint32_t>(str);
        probe.dex = dex < 0 ? 0u : static_cast<uint32_t>(dex);
        probe.intel = intel < 0 ? 0u : static_cast<uint32_t>(intel);
        probe.luk = luk < 0 ? 0u : static_cast<uint32_t>(luk);
        bool jobMismatch = false;
        if (canEnable && !ui.prefsBinDir.empty()) {
            xcat::PayloadStatus ps{};
            if (xcat::ReadPayloadStatus(ui.prefsBinDir.c_str(), ps) &&
                xcat::PayloadStatusHeartbeatFresh(ps, GetTickCount64(), 5000) &&
                ps.playerCharValid != 0) {
                jobMismatch = !xcat::AutoStatJobRatioOk(ps.playerJob, probe);
            }
        }
        ...
        if (jobMismatch) {
            ImGui::Dummy(ImVec2(0.f, ui::Gap() * 0.25f));
            ImGui::PushTextWrapPos(ImGui::GetCursorPos().x + ImGui::GetContentRegionAvail().x);
            ImGui::TextColored(ImVec4(0.92f, 0.16f, 0.14f, 1.f), "职业与加点不符合，请检查");
            ImGui::PopTextWrapPos();
        }
        const ImVec4 jobWarnRed(0.92f, 0.16f, 0.14f, 1.f);
        const bool pauseLook = enabled && jobMismatch;
        if (pauseLook) {
            ImGui::PushStyleColor(ImGuiCol_Text, jobWarnRed);
            ImGui::PushStyleColor(ImGuiCol_CheckMark, jobWarnRed);
        }
        ImGui::BeginDisabled(!enabled && (!canEnable || jobMismatch));
        ...
        if (pauseLook) ImGui::PopStyleColor(2);
        ImGui::SameLine();
        if (pauseLook) {
            ImGui::TextColored(jobWarnRed, "已暂停");
        } else if (canEnable) {
        ...
        if (autoStatHover) {
            ImGui::SetTooltip(
                ...
                "配比与职业主属性对不上时暂停加点（勾仍在，旁注「已暂停」，改对后自动恢复）。\n"
                "法师禁止力量/敏捷，战士禁止智力。");
        }
...
void DrawCharBootTab(LaunchUiState& ui) {
    ...
    if (ui.prefsBinDir.empty()) {
        ...
        ImGui::TextWrapped("未定位数据目录，无法读写 user.ini [char_boot]。");
        return;
    }
...
static void MobGatherApplyDisk(const xcat::PayloadControl& c) {
    ...
    gUiMobGatherSlowNearOnly = c.mobGatherSlowNearOnly != 0;
    gUiMobGatherSlowNearPx = (int)xcat::ClampMobGatherSlowNearPx(c.mobGatherSlowNearPx);
    gUiMobGatherWzLeashOn = c.mobGatherWzLeashOn != 0;
    gUiMobGatherWzLeashSlowPx = (int)xcat::ClampMobGatherWzLeashSlowPx(c.mobGatherWzLeashSlowPx);
    gUiMobGatherSkipSlowTpl = c.mobGatherSkipSlowTpl != 0;
    gUiMobGatherSkipSlowSpeed = (int)xcat::ClampMobGatherSkipSlowSpeed(c.mobGatherSkipSlowSpeed);
    ...
    gUiMobGatherReconnectHop = c.mobGatherReconnectHop != 0;
    gUiMobGatherReconnectHopPin = c.mobGatherReconnectHopPin != 0;
    gUiMobGatherReconnectHopChannel = (int)xcat::ClampMobGatherReconnectHopChannel(
        c.mobGatherReconnectHopChannel ? c.mobGatherReconnectHopChannel
                                       : xcat::kMobGatherReconnectHopChannelDefault);
    ...
    gUiMobGatherFirstGenOnly = c.mobGatherFirstGenOnly != 0;
    gUiAttackAccelClearBusy = c.attackAccelClearBusy != 0;
    gUiAttackNoCdEncounterUnbind = c.attackNoCdEncounterUnbind != 0;
...
static bool MobGatherSaveUi(LaunchUiState& ui) {
    ...
    c.mobGatherReconnectHopPin = gUiMobGatherReconnectHopPin ? 1u : 0u;
    c.mobGatherReconnectHopChannel = xcat::ClampMobGatherReconnectHopChannel(
        static_cast<uint32_t>(gUiMobGatherReconnectHopChannel < 1 ? 1
                                                                  : gUiMobGatherReconnectHopChannel));
...
void DrawMobGatherType20ProbeCard(LaunchUiState& ui) {
    ...
    ImGui::TextDisabled("BIN：数据目录/logs/sec_attack.log  ·  grep PROBE");
    xcat::PayloadStatus st{};
...
void DrawMobGatherTab(LaunchUiState& ui) {
...

    {
        ...
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                ...
                "产品名「攻击无CD」；不是技能服端 CD。\n"
                "出刀频率看「首页 → 挂机 → 出刀间隔」。\n"
                "开启后强制遇人策略：检测同图 + 先停手 + 一直有人就换频\n"
                "（别人进图立刻停手，人还在就换频；关无CD 后可再改遇人勾选）。\n"
                "调试 TAB「解绑」可解除该强制，遇人三项改回可勾选。\n"
                "进图落地约 0.4s 内暂停写入，降低脱同步。\n"
                "开启后测谎关题立刻软重连清 FLAG；关掉则关题不额外拆（秒数/出刀闸到点仍拆）。\n"
        ...
        }
        {
            ...
            if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled |
                ...
                ImGui::SetTooltip(
                    ...
                    "连续 N 次（默认 1）才换。已经掉过血 / 打出真伤的浮动 MISS 不计。\n"
        ...
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "默认开，但须本 TAB 已解锁才生效；未解锁不计刀、不拆。\n"
                "本勾选只开累计出刀闸，与同卡「主动软重连」秒数闸互不绑架。\n"
                "OnFuncKey 调用成功即 +1（空挥/引擎吞刀都计，不看命中）。\n"
                "到阈值必须先拆清 FLAG，卖装/赶路不得插队。落地清零。\n"
        ...
        MobGatherDragU(ui, "出刀", "hangup_fires", &gUiMobGatherHangupFires,
                       ...
                       10.f, "刀",
                       "落地后累计出刀达此主动软重连。OnFuncKey 成功即 +1（空挥/吞刀都计，不看命中）。换怪不清。\n"
        ...
        if (xcat::ui::OptionCheckbox("重连换频", &gUiMobGatherReconnectHop))
            MobGatherTrySaveOrRevert(ui);
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "默认关。勾上后，吸怪挂机时软断连（主动 hangup 或被动踢线）进别的频，不回原频。\n"
                "上一轮已经换过的频，落地后再被踢也会再抽，不会粘在当前频。\n"
                "勾了「指定频道」则不随机，首次进游戏和之后每次重连都只进那个频。\n"
                "须开首页「软重连试连」。见人仍由遇人策略换频，本勾不抢。\n"
                "仅一频或抽空则进原频。不走 F10 官方迁频。落盘 user.ini。");
        }
        ImGui::SameLine();
        ImGui::BeginDisabled(!gUiMobGatherReconnectHop);
        if (xcat::ui::OptionCheckbox("指定频道", &gUiMobGatherReconnectHopPin))
            MobGatherTrySaveOrRevert(ui);
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "默认关。须先勾「重连换频」。\n"
                "填標題栏「頻道 N」那个数字。首次自动进和之后每次重连都只进这一频。\n"
                "人满或进不去就停在选频页一直等，不会改抽别的频、不拆登录票。\n"
                "遇人「一直有人就换频」本轮仍走遇人已选的频；下一轮 hangup 再钉回指定频。\n"
                "落盘 user.ini。");
        }
        ImGui::SameLine();
        ImGui::SetNextItemWidth(AppDpi_Px(48.f));
        ImGui::BeginDisabled(!gUiMobGatherReconnectHop || !gUiMobGatherReconnectHopPin);
        if (xcat::ui::DragIntClamped("##reconnect_hop_ch", &gUiMobGatherReconnectHopChannel,
                                     static_cast<int>(xcat::kMobGatherReconnectHopChannelMin),
                                     static_cast<int>(xcat::kMobGatherReconnectHopChannelMax))) {
            gUiMobGatherReconnectHopChannel =
                static_cast<int>(xcat::ClampMobGatherReconnectHopChannel(
                    static_cast<uint32_t>(gUiMobGatherReconnectHopChannel < 1
                                              ? 1
                                              : gUiMobGatherReconnectHopChannel)));
            MobGatherTrySaveOrRevert(ui);
        ...
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip("標題「頻道 N」。范围 1–64。拖动松手或双击填写后失焦才生效。");
        }
        ImGui::EndDisabled();
        ImGui::EndDisabled();
    }
    CardGap();
    {
        ...
        if (xcat::ui::OptionCheckbox("只吸场上的", &gUiMobGatherFirstGenOnly))
            MobGatherTrySaveOrRevert(ui);
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "默认开。只吸这一次进图/重连回图时已经站在场上的怪。\n"
                "之后新刷、分裂、召唤的不吸。换图或软重连会重新收这一波。\n"
                "BIN：onField latch n= / skipGen=（新 oid） why=gen。落盘 user.ini。");
        }
    ...
    CardGap();
    {
        ...
        ImGui::PopTextWrapPos();
        if (xcat::ui::OptionCheckbox("按怪速限制远处新收", &gUiMobGatherSlowNearOnly))
            MobGatherTrySaveOrRevert(ui);
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "默认开。按 WZ 移速自动限制未吸住怪的新收距离：乌龟（-50）只用下面「最慢距离」；\n"
                "越快允许越远；红螃蟹/青螃蟹（-10/0）及以上不限制、照常 hop。\n"
                "中间速度在最慢距离与「远怪接力」之间插值，不 hop。关=全部按原半径/接力\n"
                "（海龟沙滩可能服端断）。未知模板不限制。BIN：skipSlow= / spd= / cap= / why=slow。");
        }
        ImGui::BeginDisabled(!gUiMobGatherSlowNearOnly);
        MobGatherDragU(ui, "最慢距离", "slownear", &gUiMobGatherSlowNearPx,
                       (int)xcat::kMobGatherSlowNearPxMin, (int)xcat::kMobGatherSlowNearPxMax, 10.f,
                       "px",
                       "WZ speed≤-50 允许新收的距人距离，默认 320。0=最慢档完全不新收。\n"
                       "已吸住的不丢。只防爆钳 800。中间速度在此值与远怪接力之间插值。\n"
                       "BIN：SetSlowNearPx / tick cap=。");
        ImGui::EndDisabled();
        ImGui::PushTextWrapPos(0.f);
        ImGui::TextDisabled("越慢越近才新收；青螃蟹海滩I 不额外限制。");
        ImGui::PopTextWrapPos();
        if (xcat::ui::OptionCheckbox("按怪速限制拉速", &gUiMobGatherWzLeashOn))
            MobGatherTrySaveOrRevert(ui);
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "默认关。开=远处慢怪仍吸，但每帧瞄点推进按 WZ 移速限制（对准服端自量位移）。\n"
                "乌龟用下面「最慢拉速」（默认 10px/帧）；红/青螃蟹不额外限、照常 hop。\n"
                "与「按怪速限制远处新收」同时开时，本项优先：仍收远处，只限拉速。\n"
                "BIN：MobFhBan impact wz= / tick wzLeash=。");
        }
        ImGui::BeginDisabled(!gUiMobGatherWzLeashOn);
        MobGatherDragU(ui, "最慢拉速", "wzleash", &gUiMobGatherWzLeashSlowPx,
                       (int)xcat::kMobGatherWzLeashSlowPxMin, (int)xcat::kMobGatherWzLeashSlowPxMax,
                       1.f, "px/帧",
                       "WZ speed≤-50 每帧允许推进的瞄点距离，默认 10。只防爆钳 2–48。\n"
                       "还断就调小；不断可逐步调大换吸得更快。BIN：SetWzLeash / impact wz=。");
        ImGui::EndDisabled();
        ImGui::PushTextWrapPos(0.f);
        ImGui::TextDisabled("限的是每帧位移，不是 hop 距；青螃蟹不额外限。");
        ImGui::PopTextWrapPos();
        if (xcat::ui::OptionCheckbox("不吸慢速怪", &gUiMobGatherSkipSlowTpl))
            MobGatherTrySaveOrRevert(ui);
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "默认关。勾上后：WZ 移速小于等于下面阈值的怪不新收（乌龟默认 -50）。\n"
                "阈值调高（如 -20）会连绿水灵也不吸；调低（如 -70）只跳过木妖那种更慢的。\n"
                "已吸住的不丢。表空/未知模板当 0，默认阈值下仍吸。BIN：skipTpl= / skipSp= / thr= / why=slowsp。");
        }
        ImGui::BeginDisabled(!gUiMobGatherSkipSlowTpl);
        MobGatherDragU(ui, "速度阈值", "skiptpl", &gUiMobGatherSkipSlowSpeed,
                       (int)xcat::kMobGatherSkipSlowSpeedMin, (int)xcat::kMobGatherSkipSlowSpeedMax,
                       1.f, "",
                       "WZ speed ≤ 此值的未吸住怪不收。默认 -50（乌龟及更慢）。\n"
                       "数越大=越快的也跳过。只防爆钳 -80…40。BIN：SetSkipSlowSpeed / skipSp=。");
        ImGui::EndDisabled();
        ImGui::PushTextWrapPos(0.f);
        ImGui::TextDisabled("慢于等于此 WZ 速度的怪不下手吸；已吸住的继续。");
        ImGui::PopTextWrapPos();
        if (xcat::ui::OptionCheckbox("位移夹速", &gUiMobGatherDispClampOn))
            MobGatherTrySaveOrRevert(ui);
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_AllowWhenDisabled)) {
            ImGui::SetTooltip(
                "把被拽怪每帧位移夹到不超过右边的上限（默认关）。\n"
    ...
    CardGap();
    {
        ...
        MobGatherDragU(ui, "高度闸", "dylim", &gUiMobGatherDyLimPx, (int)xcat::kMobGatherDyLimPxMin,
                       ...
                       "新收竖直上限 |mobY-人Y|，默认 8000。AbsPos 更大 Y = 更高。用户自填。\n"
        ...
        MobGatherDragU(ui, "脚边", "feet", &gUiMobGatherFeetExemptPx,
                       ...
                       10.f, "px",
                       "距人 hypot ≤此不走履历闸和高度闸，照吸。默认 8000。用户自填。\n"
    ...
    CardGap();
    {
        ...
        if (ImGui::Button("恢复默认##mg_biz_reset")) {
            ...
            gUiMobGatherSlowNearOnly = xcat::kMobGatherSlowNearOnlyDefault != 0;
            gUiMobGatherSlowNearPx = (int)xcat::kMobGatherSlowNearPxDefault;
            gUiMobGatherWzLeashOn = xcat::kMobGatherWzLeashOnDefault != 0;
            gUiMobGatherWzLeashSlowPx = (int)xcat::kMobGatherWzLeashSlowPxDefault;
            gUiMobGatherSkipSlowTpl = xcat::kMobGatherSkipSlowTplDefault != 0;
            gUiMobGatherSkipSlowSpeed = (int)xcat::kMobGatherSkipSlowSpeedDefault;
            gUiMobGatherAntiReport = false;
            MobGatherTrySaveOrRevert(ui);
        }
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal)) {
            ImGui::SetTooltip(
                "业务旋钮回实测稳组合：策略 A、半径 1000、位移夹速关/48、到站落地关。\n"
