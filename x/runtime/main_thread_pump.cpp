...
constexpr uint32_t kRvaSendWillRenderCanvases = 0x528acc0;  // remounted 2026-08-06 Canvas.SendWillRenderCanvases
constexpr uint32_t kRvaSceneLoginUpdate = 0xC1F260;         // remounted 2026-08-06
constexpr uint32_t kRvaWorldManagerFixedUpdate = 0xDF4A50;  // remounted 2026-08-06
constexpr uint32_t kRvaWorldManagerUpdate = 0xDF8870;       // remounted 2026-08-06
...
bool InstallPump() {
    ...
    if (!BindApis()) {
        FailLogThrottled("BindApis fail (wait GA)");
        return false;
    }
