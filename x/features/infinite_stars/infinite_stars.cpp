...
//   ItemSlotBundle.SetItemNumber  RVA 0x13037F0  `mov [rcx+0x28], dx; ret` + NOP
//   ItemSlotBundle.GetItemNumber  RVA 0x1303800  `movzx eax, [rcx+0x28]; ret` + NOP
...
constexpr uint32_t kRvaSetItemNumber = 0x13037F0;
constexpr uint32_t kRvaGetItemNumber = 0x1303800;
