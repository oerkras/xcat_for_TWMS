...
constexpr uint32_t kRvaSetTargetFps = 0x4DE6D40;  // Application.set_targetFrameRate
constexpr uint32_t kRvaGetTargetFps = 0x4DE6D00;  // Application.get_targetFrameRate
constexpr uint32_t kRvaSetVSync = 0x4E020A0;      // QualitySettings.set_vSyncCount
...
// set_targetFrameRate@0x4DE6D40 / set_vSyncCount@0x4E020A0：保存 ecx → resolve → jmp icall。
