...
constexpr uint32_t kRvaSetTargetFps = 0x4E28A50;  // Application.set_targetFrameRate
constexpr uint32_t kRvaGetTargetFps = 0x4E28A10;  // Application.get_targetFrameRate
constexpr uint32_t kRvaSetVSync = 0x4E43DB0;      // QualitySettings.set_vSyncCount
...
// set_targetFrameRate@0x4E28A50 / set_vSyncCount@0x4E43DB0：保存 ecx → resolve → jmp icall。
