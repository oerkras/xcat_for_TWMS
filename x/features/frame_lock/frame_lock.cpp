...
// remount 2026-08-04 dump.cs.restored.C
constexpr uint32_t kRvaSetTargetFps = 0x4DE2D70;  // Application.set_targetFrameRate
constexpr uint32_t kRvaGetTargetFps = 0x4DE2D30;  // Application.get_targetFrameRate
constexpr uint32_t kRvaSetVSync = 0x4DFE0D0;      // QualitySettings.set_vSyncCount
...
// set_targetFrameRate@0x4DE2D70 / set_vSyncCount@0x4DFE0D0：保存 ecx → resolve → jmp icall。
