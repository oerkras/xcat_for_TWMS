...
// Data-plane invuln (v2.6.5): +0x270 i-frame; anti-blink = frame tick + 8ms backup.
// Soft tick gate disabled. Bind SSOT = WM.MyUser@+0x28, FindAll fallback.
// Field hashes remounted 2026-08-13 (User type-seq, not equal-offset); offs 0x270/0x280/….
